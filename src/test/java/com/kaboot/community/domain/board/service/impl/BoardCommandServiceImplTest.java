...
class BoardCommandServiceImplTest {
    ...
    void postBoardSuccess() {
        ...
        PostOrModifyRequest validPostRequest = new PostOrModifyRequest("title", "content", "img", "url");
    ...
    void postBoardFailNotExistMember() {
        ...
        PostOrModifyRequest validPostRequest = new PostOrModifyRequest("title", "content", "img", "url");
        when(memberQueryService.getMemberByUsername(invalidUsername)).thenThrow(new CustomException(CustomResponseStatus.MEMBER_NOT_EXIST));
    ...
    void modifyPostSuccessValidMember() {
        ...
        PostOrModifyRequest validModifyRequest = new PostOrModifyRequest("modify title", "modify content", "modify img", "modify url");
    ...
    void modifyPostFailNotAuthMember() {
        ...
        //when
        assertThatThrownBy(() -> boardCommandService.modifyBoard(invalidUsername, validModifyRequest, boardId))
                .isInstanceOf(CustomException.class)
    ...
    void deletePostSuccessValidMember() {
        ...
        //when
        boardCommandService.deleteBoard(authUsername, boardId);
    ...
    void postCommentFailNotExistMember() {
        ...
        //when, then
        assertThatThrownBy(() -> boardCommandService.postComment(invalidUsername, 1L, postCommentRequest))
                .isInstanceOf(CustomException.class)
                .hasMessage(CustomResponseStatus.MEMBER_NOT_EXIST.getMessage());
    }
    ...
    void postCommentFailNotExistBoard() {
        ...
        CommentPostOrModifyRequest postCommentRequest = new CommentPostOrModifyRequest("new content");
        when(memberQueryService.getMemberByUsername(authUsername)).thenReturn(member);
        when(boardQueryService.getBoardById(anyLong())).thenThrow(new CustomException(CustomResponseStatus.BOARD_NOT_EXIST));
    ...
    void modifyCommentSuccess() {
        ...
        CommentPostOrModifyRequest modifyCommentRequest = new CommentPostOrModifyRequest("modify content");
